...
<body>
    ...
    <form method="post" action="/projet/controller/user/responsable/edit_stn.php" role="form">
	<div class="modal-body">
            ...
            //          require (__DIR__."/../../../model/user/responsable_model.php");
              ...
              <div class="form-group">
                  ...
                  <input type="datetime-local" class="form-control" id="date" name="date" value="<?php echo $sou['date'];?>" />
              </div>
              <div class="form-group">
